...
@section('content')
    ...
    <div class="container grid mt-6 px-6 mx-auto">
        ...
        <div class="flex items-center justify-between">
            <h4 class="mb-4 font-semibold text-gray-500 dark:text-gray-400">
                All {{ $title }}
            </h4>
            <a class="inline-flex items-center justify-center text-base px-2 py-2 mb-4 w-40 text-white transition-colors duration-150 bg-blue-800 hover:bg-blue-700 rounded-md focus:outline-none focus:shadow-outline-purple"
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                                        ...
                                        <form action="{{ route('categories.destroy', $category->slug) }}" method="POST">
                                            ...
                                            <div class="mt-4 mb-6">
                                                ...
                                                <p class="text-sm text-gray-700 dark:text-gray-400">
                                                    Are you sure want to delete {{ $category->category_name }} category?
                                                </p>
                                            </div>
                                            <footer
                                                ...
                                                <button type="submit"
                                                    class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-800 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple">
                                                    Accept
                                                </button>
                                        </form>
                    ...
                    @else
                        <tr>
                            <td class="px-4 py-3 text-center text-sm text-gray-700 dark:text-gray-400" colspan="10">No
                                data</td>
                        </tr>
                    @endif
                </table>
