                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="mt-4 text-sm">
                        <label for="category_name" class="block text-sm">
                            ...
                            <input type="text" id="category_name" name="category_name"
                                ...
                                autofocus placeholder="Category Name" value="{{ $category->category_name }}" />
                        </label>
                    ...
                    <div class="mt-4 text-sm">
                        <label for="slug" class="block text-sm">
                            ...
                            <input type="text" id="slug" name="slug"
                                ...
                                readonly placeholder="Slug" required value="{{ $category->slug }}" />
                        </label>
                        <span class="help-block with-errors"></span>
                        @error('slug')
                            <span class="invalid-feedback text-xs text-red-400 pt-1" role="alert">
                    ...
                    <div class="flex items-center justify-end">
                        <button type="submit"
                            ...
                            <span class="ml-2 text-sm">update Project</span>
                        </button>
                    </div>
                </div>
            </form>
